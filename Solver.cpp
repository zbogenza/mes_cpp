#include "GlobData.h"
#include "SolveMatrix.h"  // Zakładając, że masz funkcję SolveMatrix do rozwiązania układu równań
#include "FeSM_Heat.h"
#include <iostream>
...
void SOLVER() {
    ...
    // Rozwiązanie układu równań dla pełnej macierzy
    if (!SolveSquareMatrix(globalMatrix, globalB, solutionX)) {
        //std::cerr << "Solver nie powiódł się.\n";
        return;
    }
